    ...
    describe '.add' do
      ...
      context 'when the same line is added' do
        ...
        it 'returns two non-unique access' do
          expect(total.non_unique).to eq(2)
        end
      end
